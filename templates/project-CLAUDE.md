# CLAUDE.md — project-level context for this repository
...
- `agent-orchestrator.yaml` lives at the repository root.
...
When the user asks for work in this repository, Claude (CEO) should:
...
## Mandatory brief content for workers in this repository
...
- <List any gotchas workers keep hitting in this repository>
